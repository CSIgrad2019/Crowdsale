...
contract PupperCoinSale is Crowdsale, MintedCrowdsale, CappedCrowdsale, TimedCrowdsale, RefundablePostDeliveryCrowdsale {
    constructor(
        ...
        uint cap,  //adds a cap to your crowdsale, invalidating any purchases that would exceed that cap
        uint openingTime, 
        uint closingTime
    )
...
contract PupperCoinCrowdsaleDeployer {
        ...
        public
    {
        ...
        PupperCoinSale pupper_token_sale = new PupperCoinSale(1, wallet, token, goal, cap, now, now + 4 minutes);
